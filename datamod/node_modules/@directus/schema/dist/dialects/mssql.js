...
var MSSQL = /** @class */ (function () {
    ...
    // Overview
    // ===============================================================================================
    MSSQL.prototype.overview = function () {
        var _a;
                            ...
                            if (column.table_name in overview === false) {
                                overview[column.table_name] = {
                                    primary: (_a = columns[0].find(function (nested) {
                                        return (nested.table_name === column.table_name &&
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = this.knex
                            .select('c.TABLE_NAME', 'c.COLUMN_NAME', 'c.COLUMN_DEFAULT', 'c.DATA_TYPE', 'c.CHARACTER_MAXIMUM_LENGTH', 'c.NUMERIC_PRECISION', 'c.NUMERIC_SCALE', 'c.IS_NULLABLE', 'c.COLLATION_NAME', 'pk.CONSTRAINT_TABLE_NAME', 'pk.CONSTRAINT_COLUMN_NAME', 'pk.CONSTRAINT_NAME', 'pk.PK_SET', 'rc.UPDATE_RULE', 'rc.DELETE_RULE', 'rc.MATCH_OPTION')
                        ...
                        return [4 /*yield*/, query.andWhere({ 'c.column_name': column }).first()];
                    case 1:
                        rawColumn = _a.sent();
                        return [2 /*return*/, {
    ...
    MSSQL.prototype.primary = function (table) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.knex.raw("SELECT Col.Column_Name from INFORMATION_SCHEMA.TABLE_CONSTRAINTS Tab, INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE Col WHERE Col.Constraint_Name = Tab.Constraint_Name AND Col.Table_Name = Tab.Table_Name AND Constraint_Type = 'PRIMARY KEY' AND Col.Table_Name = '" + table + "'")];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results[0]['Column_Name']];
                }
            });
        });
    };
