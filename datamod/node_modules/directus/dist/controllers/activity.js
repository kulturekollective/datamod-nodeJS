...
router.post('/comment', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
...
router.patch('/comment/:pk', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/comment/:pk', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
    });
