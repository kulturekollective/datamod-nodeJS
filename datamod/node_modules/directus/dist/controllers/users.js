...
router.post('/', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.get('/me', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
router.get('/:pk', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const items = yield service.readByKey(pk, req.sanitizedQuery);
    res.locals.payload = { data: items || null };
    return next();
})), respond_1.respond);
router.patch('/me', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
...
router.patch('/me/track/page', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
...
router.patch('/:pk', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
    const pk = req.params.pk.includes(',') ? req.params.pk.split(',') : req.params.pk;
    const primaryKey = yield service.update(req.body, pk);
    try {
        const item = yield service.readByKey(primaryKey, req.sanitizedQuery);
        res.locals.payload = { data: item || null };
    }
...
router.delete('/', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete('/:pk', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.UsersService({
        accountability: req.accountability,
        schema: req.schema,
    });
    const pk = req.params.pk.includes(',') ? req.params.pk.split(',') : req.params.pk;
    yield service.delete(pk);
    return next();
})), respond_1.respond);
...
router.post('/invite', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield service.inviteUser(req.body.email, req.body.role);
    return next();
})), respond_1.respond);
...
router.post('/invite/accept', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/me/tfa/enable/', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
...
router.post('/me/tfa/disable', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _e;
