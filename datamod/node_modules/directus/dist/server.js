    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        server.on('request', function (req, res) {
            ...
            const complete = lodash_1.once(function (finished) {
                ...
                emitter_1.default.emitAsync('response', info).catch((err) => logger_1.default.warn(err));
            });
        ...
        function beforeShutdown() {
            return __awaiter(this, void 0, void 0, function* () {
                yield emitter_1.default.emitAsync('server.stop.before', { server });
        ...
        function onShutdown() {
            return __awaiter(this, void 0, void 0, function* () {
                emitter_1.default.emitAsync('server.stop').catch((err) => logger_1.default.warn(err));
                if (process.env.NODE_ENV !== 'development') {
