...
class FieldsService {
    ...
    readAll(collection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.accountability && this.accountability.admin !== true) {
                const permissions = yield this.knex
    ...
    createField(collection, field, table // allows collection creation to
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (!!(yield this.knex.select('id').from('directus_fields').where({ collection, field: field.field }).first())) {
                throw new exceptions_1.InvalidPayloadException(`Field "${field.field}" already exists in collection "${collection}"`);
            }
            if (field.schema) {
                if (table) {
                    ...
                    yield database_1.default.schema.alterTable(collection, (table) => {
                        this.addColumnToTable(table, field);
                    });
                }
            }
    ...
    deleteField(collection, field) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const relations = yield this.knex
                .select('*')
    ...
    addColumnToTable(table, field, alter = false) {
        var _a, _b, _c, _d;
        if (!field.schema)
            return;
        let column;
        if ((_a = field.schema) === null || _a === void 0 ? void 0 : _a.has_auto_increment) {
            ...
            column = table[type](field.field, ((_b = field.schema) === null || _b === void 0 ? void 0 : _b.numeric_precision) || 10, ((_c = field.schema) === null || _c === void 0 ? void 0 : _c.numeric_scale) || 5);
        }
        ...
        if ((_d = field.schema) === null || _d === void 0 ? void 0 : _d.is_primary_key) {
            column.primary();
        }
        if (alter) {
            column.alter();
