...
import { GraphQLSchema, GraphQLResolveInfo, ObjectFieldNode, FieldNode, ArgumentNode } from 'graphql';
...
export declare class GraphQLService {
    ...
    resolve(info: GraphQLResolveInfo): Promise<Partial<Record<string, any>> | null>;
    getData(collection: string, selections: FieldNode[], argsArray: readonly ArgumentNode[], variableValues: GraphQLResolveInfo['variableValues']): Promise<Partial<Record<string, any>> | null>;
