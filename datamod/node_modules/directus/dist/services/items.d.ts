...
export declare class ItemsService<Item extends AnyItem = AnyItem> implements AbstractService {
    ...
    create(data: Partial<Item>): Promise<PrimaryKey>;
    readByQuery(query: Query): Promise<null | Partial<Item> | Partial<Item>[]>;
    ...
    readSingleton(query: Query): Promise<Partial<Item>>;
    upsertSingleton(data: Partial<Item>): Promise<string | number | PrimaryKey[]>;
}
