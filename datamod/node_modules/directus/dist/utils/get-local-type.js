...
function getLocalType(column, field) {
    ...
    if ((_a = field === null || field === void 0 ? void 0 : field.special) === null || _a === void 0 ? void 0 : _a.includes('json'))
        return 'json';
    if ((_b = field === null || field === void 0 ? void 0 : field.special) === null || _b === void 0 ? void 0 : _b.includes('csv'))
        return 'csv';
    if ((_c = field === null || field === void 0 ? void 0 : field.special) === null || _c === void 0 ? void 0 : _c.includes('uuid'))
        return 'uuid';
    if (type) {
        return type.type;
    }
