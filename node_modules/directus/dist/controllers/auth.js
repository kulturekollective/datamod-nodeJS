...
router.post('/login', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (mode === 'cookie') {
        res.cookie('directus_refresh_token', refreshToken, {
            ...
            secure: env_1.default.REFRESH_TOKEN_COOKIE_SECURE === 'true' ? true : false,
...
router.post('/refresh', cookie_parser_1.default(), express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
        role: null,
...
router.post('/logout', cookie_parser_1.default(), express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
        role: null,
...
router.post('/password/request', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.body.email) {
...
router.post('/password/reset', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.body.token) {
...
router.get('/oauth', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/oauth/:provider', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    ...
    if (((_b = req.query) === null || _b === void 0 ? void 0 : _b.redirect) && req.session) {
        req.session.redirect = req.query.redirect;
    }
    next();
})), respond_1.respond);
router.use(grant_1.default.express()(grant_2.default));
router.get('/oauth/:provider/callback', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    ...
    const email = get_email_from_profile_1.default(req.params.provider, (_c = req.session.grant.response) === null || _c === void 0 ? void 0 : _c.profile);
