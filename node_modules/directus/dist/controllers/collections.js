...
router.get('/:collection', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield collectionsService.delete(req.body);
    return next();
})), respond_1.respond);
router.delete('/:collection', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
