...
router.get('/:collection', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.get('/:collection/:field', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
const newFieldSchema = joi_1.default.object({
    ...
    type: joi_1.default.string().valid(...types_1.types, null),
...
router.post('/:collection', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.body.schema && !req.body.meta)
        throw new exceptions_1.InvalidPayloadException(`"schema" or "meta" is required`);
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection/:field', collection_exists_1.default, 
// @todo: validate field
express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/:collection/:field', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new fields_1.FieldsService({
        accountability: req.accountability,
        schema: req.schema,
    });
