...
const multipartHandler = express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/', multipartHandler, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/import', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fileResponse = yield axios_1.default.get(req.body.url, {
        responseType: 'stream',
    });
...
router.patch('/:pk', multipartHandler, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.FilesService({
        accountability: req.accountability,
        schema: req.schema,
    });
    ...
    if (req.is('multipart/form-data')) {
        ...
        yield service.update(req.body, keys);
    }
    try {
        const record = yield service.readByKey(keys, req.sanitizedQuery);
        res.locals.payload = { data: record || null };
