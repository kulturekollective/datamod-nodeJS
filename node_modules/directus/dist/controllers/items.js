...
router.get('/:collection/:pk', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.singleton) {
        throw new exceptions_1.RouteNotFoundException(req.path);
    }
    const service = new services_1.ItemsService(req.collection, {
...
router.patch('/:collection/:pk', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.singleton) {
        throw new exceptions_1.RouteNotFoundException(req.path);
    }
    const service = new services_1.ItemsService(req.collection, {
    ...
    const primaryKey = req.params.pk.includes(',') ? req.params.pk.split(',') : req.params.pk;
    const updatedPrimaryKey = yield service.update(req.body, primaryKey);
    try {
...
router.delete('/:collection', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete('/:collection/:pk', collection_exists_1.default, express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_1.ItemsService(req.collection, {
        accountability: req.accountability,
        schema: req.schema,
    });
