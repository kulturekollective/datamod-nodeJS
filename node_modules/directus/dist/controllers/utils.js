...
router.get('/random/string', express_async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
router.post('/hash/generate', express_async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
...
router.post('/hash/verify', express_async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
...
router.post('/sort/:collection', collection_exists_1.default, express_async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/revert/:revision', express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
