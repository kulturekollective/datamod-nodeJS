    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function run(collection, children, query) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const dbQuery = yield getDBQuery(knex, collection, columnsToSelect, query, primaryKeyField, schema);
                ...
                for (const nestedNode of nestedNodes) {
                    ...
                    let nestedItems = yield runAST(nestedNode, schema, { knex, child: true });
                    if (nestedItems) {
                ...
                // fields
                if ((options === null || options === void 0 ? void 0 : options.child) !== true) {
...
function getDBQuery(knex, table, columns, query, primaryKeyField, schema) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield apply_query_1.default(knex, table, dbQuery, queryCopy, schema);
        return dbQuery;
    });
}
...
function mergeWithParentItems(nestedItem, parentItem, nestedNode, o2mLimit) {
