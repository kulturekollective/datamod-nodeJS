...
exports.sendPasswordResetMail = exports.sendInviteMail = void 0;
...
function getDefaultTemplateOptions() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            projectLogo: (projectInfo === null || projectInfo === void 0 ? void 0 : projectInfo.project_logo) ? getProjectLogoURL(projectInfo.project_logo)
...
function sendMail(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield transporter.sendMail(Object.assign(Object.assign({}, options), { html: html }));
        }
        catch (error) {
