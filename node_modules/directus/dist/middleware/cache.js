...
const checkCacheMiddleware = express_async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (!cache_1.default)
        return next();
    if ((_a = req.headers['cache-control']) === null || _a === void 0 ? void 0 : _a.includes('no-cache'))
        return next();
    ...
    if (cachedData) {
        ...
        if (env_1.default.CACHE_AUTO_PURGE !== true) {
            ...
            const access = !!((_b = req.accountability) === null || _b === void 0 ? void 0 : _b.role) === false ? 'public' : 'private';
