...
exports.respond = express_async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    if (req.method.toLowerCase() === 'get' && env_1.default.CACHE_ENABLED === true && cache_1.default && !req.sanitizedQuery.export) {
        ...
        if (env_1.default.CACHE_AUTO_PURGE !== true) {
            ...
            const access = !!((_a = req.accountability) === null || _a === void 0 ? void 0 : _a.role) === false ? 'public' : 'private';
