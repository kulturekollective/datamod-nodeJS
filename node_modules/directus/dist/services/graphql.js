...
class GraphQLService {
    ...
    getSchema() {
        return __awaiter(this, void 0, void 0, function* () {
            const collectionsInSystem = yield this.collectionsService.readByQuery();
            const fieldsInSystem = yield this.fieldsService.readAll();
            const relationsInSystem = (yield this.relationsService.readByQuery({}));
    ...
    resolve(info) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const selections = (_d = (_c = (_b = info.fieldNodes[0]) === null || _b === void 0 ? void 0 : _b.selectionSet) === null || _c === void 0 ? void 0 : _c.selections) === null || _d === void 0 ? void 0 : _d.filter((node) => node.kind === 'Field');
            if (!selections)
                return null;
    ...
    getData(collection, selections, argsArray, variableValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parseFields = (selections, parent) => {
                ...
                for (const selection of selections) {
                    ...
                    if (selection.selectionSet === undefined) {
                        ...
                        const children = parseFields(selection.selectionSet.selections.filter((selection) => selection.kind === 'Field'), current);
                    ...
                    if (selection.arguments && selection.arguments.length > 0) {
                        ...
                        query.deep[current] = sanitize_query_1.sanitizeQuery(args, this.accountability);
                    }
                }
                return fields;
            };
            query.fields = parseFields(selections.filter((selection) => selection.kind === 'Field'));
            let service;
            switch (collection) {
            ...
            const result = (collectionInfo === null || collectionInfo === void 0 ? void 0 : collectionInfo.singleton) ? yield service.readSingleton(query) : yield service.readByQuery(query);
            return result;
        });
    }
