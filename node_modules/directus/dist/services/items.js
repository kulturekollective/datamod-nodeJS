...
class ItemsService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const savedPrimaryKeys = yield this.knex.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const customProcessed = yield emitter_1.default.emitAsync(`${this.eventScope}.create.before`, payloads, {
    ...
    readByQuery(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield run_ast_1.default(ast, this.schema, { knex: this.knex });
            return records;
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.knex.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const single of payloads) {
                    let payload = lodash_1.clone(single);
    ...
    delete(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.accountability && this.accountability.admin !== true) {
                ...
                yield authorizationService.checkAccess('delete', this.collection, key);
            }
    ...
    readSingleton(query) {
        return __awaiter(this, void 0, void 0, function* () {
            query = lodash_1.clone(query);
            query.single = true;
            const record = (yield this.readByQuery(query));
            if (!record) {
