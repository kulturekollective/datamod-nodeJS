...
function applyQuery(knex, collection, dbQuery, query, schema) {
    return __awaiter(this, void 0, void 0, function* () {
        if (query.filter) {
            yield applyFilter(knex, dbQuery, query.filter, collection);
        }
        if (query.sort) {
        ...
        if (query.search) {
            ...
            dbQuery.andWhere(function () {
                columns
                    ...
                    .filter((column) => column.data_type.toLowerCase().includes('text') || column.data_type.toLowerCase().includes('char'))
                    .forEach((column) => {
...
function applyFilter(knex, rootQuery, rootFilter, collection) {
    return __awaiter(this, void 0, void 0, function* () {
