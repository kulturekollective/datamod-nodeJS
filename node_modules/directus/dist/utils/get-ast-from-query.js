...
function getASTFromQuery(collection, query, schema, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const knex = (options === null || options === void 0 ? void 0 : options.knex) || database_1.default;
        /**
         ...
         */
        const relations = [...(yield knex.select('*').from('directus_relations')), ...relations_1.systemRelationRows];
                ...
                for (const [relationalField, nestedFields] of Object.entries(relationalStructure)) {
                    ...
                    if (relationType === 'm2a') {
                        ...
                        child = {
                            ...
                            relation: relation,
                            query: (deep === null || deep === void 0 ? void 0 : deep[relationalField]) || {},
                            children: yield parseFields(relatedCollection, nestedFields),
                        };
                    }
                    if (child) {
                        children.push(child);
        ...
        function convertWildcards(parentCollection, fields) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const allowedFields = permissions
                    ? (_b = (_a = permissions.find((permission) => parentCollection === permission.collection)) === null || _a === void 0 ? void 0 : _a.fields) === null || _b === void 0 ? void 0 : _b.split(',') : fieldsInCollection;
        ...
        function getFieldsInCollection(collection) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const fields = [
                    ...(yield knex.select('field').from('directus_fields').where({ collection })).map((field) => field.field),
