...
const querySchema = joi_1.default.object({
    ...
    deep: joi_1.default.object().pattern(/\w+/, joi_1.default.link('#query')),
}).id('query');
...
function validateFilterPrimitive(value, key) {
    if ((typeof value === 'string' || typeof value === 'number' || typeof value === 'boolean') === false) {
        throw new exceptions_1.InvalidQueryException(`The filter value for "${key}" has to be a string or a number`);
    }
